...
# with command line options: step2 --conditions GR_E_V31::All --scenario cosmics --process ALCA --data --eventcontent DQM -s RAW2DIGI:siStripDigis+siPixelDigis+gtDigis+gtEvmDigis+scalersRawToDigi,RECO:trackerlocalreco,ALCA:SiStripCalZeroBias+DQM --datatier DQM -n -1 --filein /store/data/Run2011A/Cosmics/RAW/v1/000/160/960/049F6443-8E53-E011-A943-003048F117EA.root --no_exec -n 100 --python_filename=SiStrip_badChannel_Cosmics2011A.py
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('/store/data/Run2011A/Cosmics/RAW/v1/000/160/960/049F6443-8E53-E011-A943-003048F117EA.root')
)
