            ...
            for (stepI,step) in enumerate(stepList):
                ...
                if self.wm:
                    ...
                    if stepName in [
                        ...
                        continue
                    # HACK V1: to get DIGI step submitted
                    # this is a hack - abuse step1Only in order to select step2==DIGI
#                if self.step1Only and stepI>1:
                    # HACK V2: to get RECO step submitted
                    # this is a hack - abuse step1Only in order to select step2==DIGI
                if self.step1Only and (stepI==2 or stepI==0):
                    pass
                else:
                    continue
