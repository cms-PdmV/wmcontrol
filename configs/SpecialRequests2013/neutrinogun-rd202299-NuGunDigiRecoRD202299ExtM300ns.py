...
# with command line options: STEP1 --step DIGI,L1,DIGI2RAW,HLT:7E33v2 --conditions START53_V7L::All --runsAndWeightsForMC [(202299,1.)] --pileup fromDB --eventcontent RAWSIM --datatier GEN-SIM-RAW --no_exec --python_filename=neutrinogun-rd202299-NuGunDigiRecoRD202299ExtM300ns.py -n 5 --filein=file:step1.root
