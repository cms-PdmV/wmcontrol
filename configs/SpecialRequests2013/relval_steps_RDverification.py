...
step2DefaultsRDD = { 
                  ...
                  '--eventcontent': 'FEVTDEBUGHLT',
                  '--conditions'  : 'auto:startup',
                  '--runsAndWeightsForMC' : '"[(206859,1)]"'
                  }

steps['DIGIPROD1']=merge([{'--eventcontent':'RAWSIM','--datatier':'GEN-SIM-RAW'},step2Defaults])
steps['DIGI']=merge([step2Defaults])
steps['DIGIRD']=merge([step2DefaultsRD])
steps['DIGIRDC']=merge([step2DefaultsRDC])
steps['DIGIRDD']=merge([step2DefaultsRDD])
...
steps['DIGIPU1RD']=merge([PU,step2DefaultsRD])
steps['DIGIPU1RDD']=merge([PU,step2DefaultsRDD])
