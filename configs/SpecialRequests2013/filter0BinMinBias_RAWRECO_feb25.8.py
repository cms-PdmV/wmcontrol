...
# with command line options: reco -s FILTER:Configuration/PyReleaseValidation/filterZeroBias.filterZeroBias,RAW2DIGI,RECO --data --conditions GR_R_53_V18::All --eventcontent RAWRECO --no_exec --datatier RAWRECO --filein /store/data/Run2012C/MinimumBias/RAW/v1/000/202/299/0AB4E9C2-27F8-E111-BAE8-001D09F24664.root -n 50 --python_filename=filter0BinMinBias_RAWRECO_feb25.8.py
