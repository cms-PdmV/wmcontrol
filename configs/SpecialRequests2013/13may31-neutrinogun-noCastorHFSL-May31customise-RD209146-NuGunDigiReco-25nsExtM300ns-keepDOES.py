...
# with command line options: STEP1 --step DIGI,L1,DIGI2RAW,HLT:7E33v2 --conditions START53_V7N::All --runsAndWeightsForMC [(209146,1.)] --pileup fromDB --customise=Configuration/GenProduction/noCastorHFSL_customise.customise_digi --inline_custom --eventcontent RAWSIM --datatier GEN-SIM-RAW --no_exec -n 2 --filein=file:/data/franzoni/cmssw/53x/CMSSW_5_3_9_patch3_taskForceSamplesApril/src/MB8TeVEtanoCasHFShoLib__GEN-SIM__START53_V16-v2__00001__FE332103-9E59-E211-B8FF-001E4F32EF96.root --python_filename=neutrinogun-noCastorHFSL-May31customise-RD209146-NuGunDigiReco-25nsExtM300ns-keepDOES.py --customise_commands= process.RAWSIMoutput.outputCommands.extend(cms.untracked.vstring('keep *_simEcalTriggerPrimitiveDigis_*_*','keep *_simHcalTriggerPrimitiveDigis_*_*')) \n 
...
process.source = cms.Source("PoolSource",
    ...
    setRunNumber = cms.untracked.uint32(209146)
)
