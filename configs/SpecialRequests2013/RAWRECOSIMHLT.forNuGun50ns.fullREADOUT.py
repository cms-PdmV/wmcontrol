...
# with command line options: STEP2 --step RAW2DIGI,L1Reco,RECO,VALIDATION:validation_prod,DQM:DQMOfflinePOGMC --conditions START53_V15A::All NoPileUp --datamix NODATAMIXER --eventcontent RAWRECOSIMHLT,DQM --datatier RAWRECOSIMHLT,DQM -n 10 --no_exec --filein=file:FR_STEP1_DIGI_L1_DIGI2RAW_HLT_PU.root --python_filename=RAWRECOSIMHLT.forNuGun50ns.fullREADOUT.py
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:FR_STEP1_DIGI_L1_DIGI2RAW_HLT_PU.root')
)
