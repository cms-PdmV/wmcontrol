...
K250by250={'--relval': '250000,250'}
K200by250={'--relval': '25000,250'}
...
steps['SingleGammaFlatPt10To100']=gen('SingleGammaFlatPt10To100_cfi',Kby(25,300))
#steps['SingleGammaEnergy50']=gen('SingleGammaE50_cfi',K250by100)
#steps['SingleGammaEnergy50']=gen('Configuration/Generator/python/SingleGammaE50_cfi',Kby(200,300))
steps['SingleGammaEnergy50']=gen('SingleGammaE50_cfi',Kby(200,300))
