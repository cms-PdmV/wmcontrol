...
# with command line options: STEP2 --step RAW2DIGI,L1Reco,RECO,VALIDATION:validation_prod,DQM:DQMOfflinePOGMC --conditions START53_V7L::All --eventcontent AODSIM,DQM --datatier AODSIM,DQM -n -2 --no_exec --filein=file:/data/franzoni/cmssw/53x/CMSSW_5_3_9_patch3_taskForceSamplesApril/src/prepare-ShowerLib-NuGun-runDep/run-rd209146/STEP1_DIGI_L1_DIGI2RAW_HLT_PU.root
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:/data/franzoni/cmssw/53x/CMSSW_5_3_9_patch3_taskForceSamplesApril/src/prepare-ShowerLib-NuGun-runDep/run-rd209146/STEP1_DIGI_L1_DIGI2RAW_HLT_PU.root')
)
