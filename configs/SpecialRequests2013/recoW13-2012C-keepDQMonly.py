...
# with command line options: reco -s RAW2DIGI,FILTER:hcallaserhbhehffilter2012_cff.hcallLaser2012Filter,L1Reco,RECO,DQM --data --python recoW13-2012C-keepDQMonly.py --customise Configuration/DataProcessing/RecoTLR.customisePrompt --no_exec --conditions FT_R_53_V18::All --eventcontent DQM --datatier DQM --no_exec --filein=file:/data/franzoni/data/Run2012C-MinimumBias-RAW-v1-000202016-FC906D11-36F3-E111-94C2-001D09F28E80.root -n 10
...
process.filtering_step = cms.Path(process.hcallLaser2012Filter)
