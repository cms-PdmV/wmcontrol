...
# with command line options: reco -s FILTER:Configuration/PyReleaseValidation/filterZeroBias.filterZeroBias,RAW2DIGI,RECO --data --conditions GR_R_53_V18::All --eventcontent RAW,RECO --no_exec --datatier RAW,RECO --filein /store/data/Run2012C/MinimumBias/RAW/v1/000/202/299/0AB4E9C2-27F8-E111-BAE8-001D09F24664.root -n 50 --python_filename=filter0BinMinBias_RAWRECO_feb23.8.py
...
process.RECOoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('reco_FILTER_RAW2DIGI_RECO_inRECO.root'),
    dataset = cms.untracked.PSet(
        filterName = cms.untracked.string(''),
...
# Schedule definition
process.schedule = cms.Schedule(process.filtering_step,process.raw2digi_step,process.reconstruction_step,process.endjob_step,process.RAWoutput_step,process.RECOoutput_step)
