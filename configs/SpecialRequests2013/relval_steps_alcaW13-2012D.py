...
steps['ZMuSkim2012B']={'INPUT':InputInfo(dataSet='/SingleMu/Run2012B-ZMu-PromptSkim-v1/RAW-RECO',label='zMu2012B',location='STD',run=Run2012B)}
steps['ZMuSkim2012Bv1']={'INPUT':InputInfo(dataSet='/SingleMu/Run2012B-ZMu-PromptSkim-v1/RAW-RECO',label='zMu2012Bv1',location='STD',run=Run2012Bv1)}
steps['ZMuSkim2012Bv2']={'INPUT':InputInfo(dataSet='/SingleMu/Run2012B-ZMu-PromptSkim-v2/RAW-RECO',label='zMu2012Bv2',location='STD',run=Run2012Bv2)}
#steps['ZMuSkim2012B']={'INPUT':InputInfo(dataSet='/SingleMu/Run2012B-ZMu-PromptSkim-v1/RAW-RECO',label='zMu2012B',location='CAF',run=Run2012B)}
...
Run2012Acalo=[191226] # this is for calorimeters
steps['RunJet2012Acalo']={'INPUT':InputInfo(dataSet='/Jet/Run2012A-v1/RAW',label='jet2012Acalo', run=Run2012Acalo, events=100000,location='STD')}
steps['RunElectron2012Acalo']={'INPUT':InputInfo(dataSet='/SingleElectron/Run2012A-v1/RAW',label='electron2012Acalo', run=Run2012Acalo, events=100000,location='STD')}
steps['ZElSkim2012Acalo']={'INPUT':InputInfo(dataSet='/DoubleElectron/Run2012A-ZElectron-13Jul2012-v1/RAW-RECO',label='zEl2012Acalo',location='STD',run=Run2012Acalo)}
steps['RunPhoton2012Acalo']={'INPUT':InputInfo(dataSet='/Photon/Run2012A-v1/RAW',label='photon2012Acalo',run=Run2012Acalo,events=100000,location='STD')}


Run2012Bcalo=[194533, 195016] # this is for calorimeters
steps['RunJetHT2012Bcalo']={'INPUT':InputInfo(dataSet='/JetHT/Run2012B-v1/RAW',label='jetHT2012Bcalo', run=Run2012Bcalo, events=100000,location='STD')}
steps['RunElectron2012Bcalo']={'INPUT':InputInfo(dataSet='/SingleElectron/Run2012B-v1/RAW',label='electron2012Bcalo', run=Run2012Bcalo, events=100000,location='STD')}
steps['ZElSkim2012Bcalo']={'INPUT':InputInfo(dataSet='/DoubleElectron/Run2012B-ZElectron-PromptSkim-v1/RAW-RECO',label='zEl2012Bcalo',location='STD',run=Run2012Bcalo)}
steps['RunPhoton2012Bcalo']={'INPUT':InputInfo(dataSet='/SinglePhoton/Run2012B-v1/RAW',label='photon2012Bcalo',run=Run2012Bcalo,events=100000,location='STD')}


Run2012Ccalo=[199812,203002] # this is for calorimeters
steps['RunJetHT2012Ccalo']={'INPUT':InputInfo(dataSet='/JetHT/Run2012C-v1/RAW',label='jetHT2012Ccalo', run=Run2012Ccalo, events=100000,location='STD')}
steps['RunElectron2012Ccalo']={'INPUT':InputInfo(dataSet='/SingleElectron/Run2012C-v1/RAW',label='electron2012Ccalo', run=Run2012Ccalo, events=100000,location='STD')}
steps['ZElSkim2012Ccalo']={'INPUT':InputInfo(dataSet='/DoubleElectron/Run2012C-ZElectron-PromptSkim-v3/RAW-RECO',label='zEl2012Ccalo',location='STD',run=Run2012Ccalo)}
steps['RunPhoton2012Ccalo']={'INPUT':InputInfo(dataSet='/SinglePhoton/Run2012C-v1/RAW',label='photon2012Ccalo',run=Run2012Ccalo,events=100000,location='STD')}


Run2012D=[204577,205344,207231,207454,207905,208307]
steps['ZMuSkim2012D']={'INPUT':InputInfo(dataSet='/SingleMu/Run2012D-ZMu-PromptSkim-v1/RAW-RECO',label='zMu2012D',run=Run2012D, events=100000,location='STD')}
steps['MinimumBias2012D']={'INPUT':InputInfo(dataSet='/MinimumBias/Run2012D-v1/RAW',label='minBias2012D',run=Run2012D, events=100000,location='STD')}

Run2012DMidSize=[204577,207231,207454,208307]
steps['SingMu2012D']={'INPUT':InputInfo(dataSet='/SingleMu/Run2012D-v1/RAW',label='singleMu2012D',run=Run2012DMidSize, events=100000,location='STD')}
steps['JetHT2012D']={'INPUT':InputInfo(dataSet='/JetHT/Run2012D-v1/RAW',label='JetHT2012D',run=Run2012DMidSize, events=100000,location='STD')}
steps['DoubEle2012D']={'INPUT':InputInfo(dataSet='/DoubleElectron/Run2012D-ZElectron-PromptSkim-v1/RAW-RECO',label='doubEle2012D',run=Run2012DMidSize, events=100000,location='STD')}
steps['SingPho2012D']={'INPUT':InputInfo(dataSet='/SinglePhoton/Run2012D-v1/RAW',label='singPho2012D',run=Run2012DMidSize, events=100000,location='STD')}

Run2012DSmallSize=[204577,208307]
steps['SingEle2012D']={'INPUT':InputInfo(dataSet='/SingleElectron/Run2012D-v1/RAW',label='singEle2012D',run=Run2012DSmallSize, events=100000,location='STD')}
#steps['SingEle2012D']={'INPUT':InputInfo(dataSet='/DoubleElectron/Run2012D-ZElectron-PromptSkim-v1/RAW-RECO',label='SingEle2011D',run=Run2012DSmallSize, events=100000,location='STD')}
