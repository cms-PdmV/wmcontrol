...
step1['QCD_Pt_3000_3500INPUT']={'INPUT':InputInfo(dataSet='/RelValProdQCD_Pt_3000_3500/CMSSW_4_3_0_pre2-MC_42_V9-v1/GEN-SIM',label='qcd335',location='STD')}

#step1['ZmumuJets_Pt_20_300']=merge([{'cfg':'mumuJets_Pt_20_300_7TeV_cfi','--relval':'9000,25'},step1Defaults])#DUMMY
step1['ZmumuJets_Pt_20_300PU1INPUT']={'INPUT':InputInfo(dataSet='/RelValZmumuJets_Pt_20_300/CMSSW_4_3_0_pre3-MC_43_V1-v2/GEN-SIM',label='zmm20300',location='STD')}
...
#GF insert _2
step1['QCD_Pt_3000_3500INPUT']={'INPUT':InputInfo(dataSet='/RelValQCD_Pt_3000_3500_2/CMSSW_4_4_2_patch10-START44_V7_special_120119-v1/GEN-SIM',location='STD')}
...
##attempt
#step1['Wjet_Pt_3000_3500INPUT']={'INPUT':InputInfo(dataSet='/RelValWjet_Pt_3000_3500/CMSSW_4_2_9_HLT1_patch1-START42_V14B_RelVal_Wjet_Pt_3000_3500rv_20Jun20133000INPUT']={'INPUT':InputInfo(dataSet='/RelValQCD_FlatPt_15_3000/CMSSW_4_2_9_HLT1_patch1-START42_V14B_RelVal_QCD_FlatPt_15_3000rv_20Jun2013-v1/GEN-SIM-DIGI-RAW-HLTDEBUG',label='QCD_FlatPt_15_3000rv',location='STD')}
#
...
#GF
#changeRefRelease(step1,[('CMSSW_4_3_0_pre3-START43_V1-v2','CMSSW_4_1_8_patch9-START311_V2-v1'),
#                        ('CMSSW_4_3_0_pre3-MC_43_V1-v2','CMSSW_4_1_8_patch9-START311_V2-v1')
#                        ])

# according to: https://hypernews.cern.ch/HyperNews/CMS/get/datasets/2393.html
changeRefRelease(step1,[('CMSSW_4_4_2_patch10-START44_V7_special_120119-v1','CMSSW_4_1_8_patch9-START311_V2-v1'),
                        ('CMSSW_4_3_0_pre3-MC_43_V1-v2','CMSSW_4_1_8_patch9-START311_V2-v1')
                        ])
#GF                        
...
PU1={'--pileup':'E7TeV_FlatDist10_2011EarlyData_50ns_PoissonOOT','--pileup_input':'dbs:/RelValMinBias/CMSSW_4_1_8_patch9-START311_V2-v1/GEN-SIM'}
...
# step2
# GF insert the customization function so that it's only picked up by STEP2
# to be used for the PU SAMPLES
step2Defaults = { 'cfg'           : 'step2   --customise Configuration/StandardSequences/DigiToRecoNoPU.customise --inline_cus --dump_python',
# to be  used for the NO PU samples
#step2Defaults = { 'cfg'           : 'step2   --customise Configuration/StandardSequences/DigiToRecoNoPU.customise --inline_cus',
