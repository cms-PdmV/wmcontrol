...
# customization to use these GEN-SIM in input https://hypernews.cern.ch/HyperNews/CMS/get/datasets/2393.html
baseDataSetRelease=[
...
steps['QCD_Pt_3000_3500INPUT']={'INPUT':InputInfo(dataSet='/RelValQCD_Pt_3000_3500_2/%s/GEN-SIM'%(baseDataSetRelease[0],),location='STD')}
...
# step2 
step2Defaults = { 
                  '-s'            : 'reGEN,DIGI,L1,DIGI2RAW,HLT:2011,RAW2DIGI,L1Reco',
#                  '-s'            : 'reGEN,DIGI,L1,DIGI2RAW,HLT:@relval,RAW2DIGI,L1Reco',
#                  '-s'            : 'reGEN,reSIM,DIGI,L1,DIGI2RAW,HLT:@relval,RAW2DIGI,L1Reco',
...
# modified to remove reGEN for cosmics and HALO
#steps['DIGICOS']=merge([{'--scenario':'cosmics','--eventcontent':'FEVTDEBUG','--datatier':'GEN-SIM-DIGI-RAW'},stCond,step2DefaultsCosmics])
