...
# step1 gensim
step1MB = {'--relval'      : None, # need to be explicitly set
           '-s'            : 'GEN,SIM',
           '-n'            : 10,
           '--conditions'  : 'auto:startup',
           '--datatier'    : 'GEN-SIM',
           '--eventcontent': 'RAWSIM',
           '--customise'   :  'reproc2011_2012_cff.customiseG4'
           }
...
steps['ProdMinBias']=merge([{'cfg':'MinBias_8TeV_cfi','--relval':'9000,300'},step1MB])
...
steps['MinBias']=merge([{'cfg':'MinBias_8TeV_cfi','--relval':'500000,100'},step1MB])
