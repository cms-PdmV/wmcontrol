...
# N is number of kEvents, s the splitting
def Kby(N,s):
...
steps['SingleEle_FlatPt_1_300_CustomEvCHS']=gen('SingleElectronPt35_cfi --customise_commands="process.generator.PGunParameters.MinPt=1 \\n process.generator.PGunParameters.MaxPt=300 \\n "',Kby(5000,5000))
steps['SingleGamma_FlatPt_1_300_CustomEvCHS']=gen('SingleGammaPt35_cfi --customise_commands="process.generator.PGunParameters.MinPt=1 \\n process.generator.PGunParameters.MaxPt=300 \\n"',Kby(5000,5000))
steps['QCD_Pt_30_80_BCtoE_CustomEvCHS']=gen('Configuration/GenProduction/python/EightTeV/QCD_Pt_30_80_BCtoE_TuneZ2star_8TeV_pythia6_cff.py  --customise_commands="process.bctoefilter.filterAlgoPSet.eTThreshold=1"',Kby(300,300))
steps['QCD_Pt_80_170_BCtoE_CustomEvCHS']=gen('Configuration/GenProduction/python/EightTeV/QCD_Pt_80_170_BCtoE_TuneZ2star_8TeV_pythia6_cff.py --customise_commands="process.bctoefilter.filterAlgoPSet.eTThreshold=1"',Kby(300,300))
steps['ZEE_CustomEvCHS']=gen('Configuration/Generator/python/ZEE_8TeV_cfi.py',Kby(1000,1000))
steps['PhotonJet_Pt_10EvCHS']=gen('Configuration/Generator/python/PhotonJet_Pt_10_8TeV_cfi.py',Kby(1000,1000))
steps['QCDForPF_EvCHS']=gen('Configuration/Generator/python/QCDForPF_8TeV_cfi.py',Kby(50,50))
...
steps['SingleEle_FlatPt_1_300_CustomEvCHSINPUT']={'INPUT':InputInfo(dataSet='/SingleElePt300ExtRelVal610/CMSSW_6_1_0-START61_V8-v1/GEN-SIM',location='STD')}
steps['SingleGamma_FlatPt_1_300_CustomEvCHSINPUT']={'INPUT':InputInfo(dataSet='/SingleGammaPt300ExtRelVal610/CMSSW_6_1_0-START61_V8-v1/GEN-SIM',location='STD')}
...
PUEGMGED={'-n':10,'--pileup':'2012_Startup_50ns_PoissonOOTPU','--pileup_input':'dbs:/RelValMinBias/%s/GEN-SIM'%(baseDataSetRelease[0],)}
EGMGEDNOPU={'-n':10}
EVTCONTEGMGED2={'--customise_commands':'"process.FEVTDEBUGHLToutput.outputCommands.extend(cms.untracked.vstring(\'keep *_g4SimHits_EcalHitsEB_*\',\'keep *_g4SimHits_EcalHitsEE_*\',\'keep  *_g4SimHits_EcalHitsES_*\'))"'}
EVTCONTEGMGED3={'--customise_commands':'"process.RECOSIMoutput.outputCommands.extend(cms.untracked.vstring(\'keep *_g4SimHits_EcalHitsEB_*\',\'keep *_g4SimHits_EcalHitsEE_*\',\'keep  *_g4SimHits_EcalHitsES_*\'))"'}
...
steps['DIGIEGMGED']=merge([PUEGMGED,EVTCONTEGMGED2,step2Defaults])
steps['DIGIEGMGEDPF']=merge([EVTCONTEGMGED2,step2Defaults])

steps['DIGIEGMGEDNOPU']=merge([EGMGEDNOPU,EVTCONTEGMGED2,step2Defaults])
...
steps['RECOPUEGMGED']=merge([PUEGMGED,EVTCONTEGMGED3,steps['RECO']])
steps['RECOPUEGMGEDPF']=merge([EVTCONTEGMGED3,steps['RECO']])
