...
# with command line options: step2 --conditions GR_E_V31::All --scenario pp --process ALCA --data --eventcontent DQM -s RAW2DIGI:siStripDigis+siPixelDigis+gtDigis+gtEvmDigis+scalersRawToDigi,RECO:trackerlocalreco,ALCA:SiStripCalZeroBias+DQM --datatier DQM -n -1 --filein /store/data/Run2011A/MinimumBias/RAW/v1/000/165/121/0699429A-B37F-E011-A57A-0019B9F72D71.root --no_exec -n 100 --python_filename=SiStrip_badChannel_MinBias2011A.py
