...
process.load('SimGeneral.MixingModule.mix_E8TeV_2012_25nsRunning_TrainBackOOTPU_cfi')
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:SingleElectaronPt35_cfi_GEN_SIM.root')
)
