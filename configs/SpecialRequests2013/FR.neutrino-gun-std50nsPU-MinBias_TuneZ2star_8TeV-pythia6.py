...
# with command line options: STEP1 --step DIGI,L1,DIGI2RAW,HLT:7E33v2 --conditions START53_V15A::All --pileup 2012_Summer_50ns_PoissonOOTPU --datamix NODATAMIXER --eventcontent RAWSIM --datatier GEN-SIM-RAW --no_exec --custom_conditions=EcalSRSettings_fullreadout_v01_mc,EcalSRSettingsRcd,frontier://FrontierProd/CMS_COND_34X_ECAL --python_filename=FR.neutrino-gun-std50nsPU-MinBias_TuneZ2star_8TeV-pythia6.py -n 10 --filein=file:../25.0_TTbar+TTbar+DIGI+RECO+ALCATT/TTbar-GEN-SIM.root
